...
The PR automation prompt at
`../.github/prompts/pr-generation.prompt.md` (repository root:
`.github/prompts/pr-generation.prompt.md`) uses the same workflow expectations:
